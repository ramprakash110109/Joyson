...
<!--<link rel='stylesheet' type='text/css' href='invoice/css/style.css' />
	...
	<script type='text/javascript' src='invoice/js/example2.js'></script>
	<style type="text/css">
	table td{
...
<ul class="nav nav-list">
			...
			<li class="active"><a href="billknit.php"><i  class="icon-shopping-cart icon-1x"></i> Bill Knitted </a></li> 
	...
	<div >
		...
		<br>
		<form method="post" id="target" target="_blank" action="invoice/kprint.php">
