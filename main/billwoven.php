...
<ul class="nav nav-list">
			...
			<li  class="active"><a href="billwoven.php"><i class="icon-shopping-cart icon-1x"></i> Bill Woven</a></li>      
	...
	<div >
		...
		<br>
		<form method="post" id="target" target="_blank" action="invoice/print.php">
