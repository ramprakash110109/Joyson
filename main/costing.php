...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="costing.php"><i class="icon-tags icon-2x"></i> Costing</a>
			<ul class="nav nav-list">
			
			<li><a href="wcosting.php"><i  class="icon-tags icon-1x"></i> Costing Woven</a></li>      
			<li><a href="kcosting.php"><i  class="icon-tags icon-1x"></i> Costing Knitted </a></li> 
...
<a href="wcosting.php"><i class="icon-tags icon-2x"></i><br> Costing Woven </a>      
<a href="kcosting.php"><i class="icon-tags icon-2x"></i><br> Costing Knitted</a>     
