...
<form action="saveknittedcost.php" method="post" enctype="multipart/form-data">
<center><h4><i class="icon-plus-sign icon-large"></i>Costing  Knitted </h4></center>
<hr>
...
<?php }?>
<option value="addknittedfab">Add a knitted fabric</option>
</select><br>
<span> Shirting qty(grams)</span> <input id="fqty1" type='number' class="fabq" value='0.0' min='0.0' step='0.1' style='width:265px; height:30px;' name="fab[qty][]" Required><br> <br>
<span> Suiting</span>
...
<span> Suiting qty(grams)</span> <input id='fqty2' type='number' class="fabq" value='0.0' min='0.0' step='0.1' style='width:265px; height:30px;' name="fab[qty][]" Required><br> <br> <br>
...
<table id="trimtlp">
  ...
  <tbody id="detail">
    <tr>
      <td class="count"></td>
       <td><span> Trims: </span><select id="tname" class="trimn" name='trims[name][]'  style='width:170px; height:30px; margin-left:-5px;' >
       <option value="">Choose Trims</option>'
		...
		<span> Trims qty(Pieces) </span><input class="trimq" type='number' value='0'  min='0' step='0.1' style='width:170px; height:30px;' name='trims[qty][]' >
	</td>
...
<span> Power  table charges </span><input id="ptc" class="excost" type="number"  min="0.00" step="0.01" style="width:265px; height:30px;" name="power_table" placeholder="0.00" value="0.00"><br>
<span> Printing charges </span><input id="pc" class="excost" type="number"  min="0.00" step="0.01" style="width:265px; height:30px;" name="printing" placeholder="0.00" value="0.00"><br>
<span> Embroidery charges </span><input id="ec" class="excost" type="number"  min="0.00" step="0.01" style="width:265px; height:30px;" name="embroidery" placeholder="0.00" value="0.00"><br>
...
<span> Profit (%) </span><input type="number" list="profit" id="gain" style="width:265px; height:30px;" name="profit" min="0" step="5" max="50"  placeholder="%" value="0"><br>
<span> Rate/Pcs </span><input type="text" id="rp" style="width:265px; height:30px;" name="rate"  placeholder="0.00" value="0.00" readonly="true"><br>
...
<script type="text/javascript">
    ...
    jQuery('.fname').on('change', function(){
        if(jQuery(this).val() == 'addknittedfab'){
        window.location.href = 'kfabric.php';
        }
        // and so on
        });
...
<script type="text/javascript">
	...
	function addnewrow()
	{
		var tr = '<tr>' +
                   '<td class="count"></td>'+
                    '<td><span> Trims: </span><select class="trimn" id="tname" name="trims[name][]"  style="width:170px; height:30px; margin-left:-5px;" Required>'+
       '<option value="">Choose Trims</option>'+
		<?php for($i=0; $row1 = $result3->fetch(); $i++){ ?>
		'<option value="<?php echo $row1['t_id'];?>"> <?php echo $row1['t_description']; ?></option>'+
		<?php }?> 
