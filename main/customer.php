...
<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM customer_table ORDER BY customer_id DESC");
				$result->execute();
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><?php echo '1) '.$row['contact1_name'].' - '.$row['contact1_mobile'].'</br>2) '. $row['contact2_name'].' - '.$row['contact2_mobile']; ?>
			<br><br>
