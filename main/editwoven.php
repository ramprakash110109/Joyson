...
<form action="saveeditwoven.php" method="post" enctype="multipart/form-data">
<input type="hidden" name="memi" value="<?php echo $id; ?>" />
<center><h4><i class="icon-edit icon-large"></i> Edit Woven Costing </h4></center>
<hr>
...
<span> Shirting qty(m)</span> <input id="fqty1" type='number' class="fabq" min='0.0' step='0.1' style='width:265px; height:30px;' name="fab[qty][]" value="<?php echo $row['shirting_qty'];?>" Required><br> <br>
...
<span> Suiting qty(m)</span> <input id='fqty2' type='number' class="fabq" min='0.0' step='0.1' style='width:265px; height:30px;' name="fab[qty][]" value="<?php echo $row['suiting_qty'];?>" Required><br> <br> <br>
<!-- to display trims -->
<?php
