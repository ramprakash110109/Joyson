...
include('../connect.php');
$c=$_REQUEST['customer'];
$result = $db->prepare("SELECT * FROM costing_table where customer_id='".$c."'");
$result->execute();
...
<?php 
	...
	<tr class="item-row">
		      <td colspan="5" align="center">  <a href="costing.php" style="color:red;">Costing not Found clik here to add woven costing.</a>
		      </td>
</tr>
<?php
}
