...
<a href="billing.php"><i class="icon-shopping-cart icon-2x"></i><br> Billing </a>             
<a href="costing.php"><i class="icon-tags icon-2x"></i><br>Costing</a>      
...
<a href="contractor.php"><i class="icon-group icon-2x"></i><br> Contractors</a>
<a href="purchase.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-shopping-cart icon-2x"></i><br>Purchase</a>
<a href="stocks.php"><i class="icon-list-alt icon-2x"></i><br> Stock Details</a>    
