...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="purchase.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-shopping-cart icon-2x"></i> Purchase</a> 
<ul class="nav nav-list">
			<li><a href="purchasew.php"><i class="icon-shopping-cart icon-1x"></i>Woven</a>      
...
<!--
	...
	<div class="contentheader">
			<i class="icon-shopping-cart"></i> Purchase Orders
			</div>
			<ul class="breadcrumb">
...
<a href="purchasew.php"><i class="icon-shopping-cart icon-2x"></i><br>Woven purchase</a>      
<a href="purchaseorderk.php"><i class="icon-shopping-cart icon-2x"></i><br>knit purchase</a>     
<a href="purchasesoredera.php"><i class="icon-shopping-cart icon-2x"></i><br>Accessories purchase</a>  
<!--<a href="purchasebelt.php"><i class="icon-list-alt icon-2x"></i><br>Belt</a>
<a href="purchasetie.php"><i class="icon-list-alt icon-2x"></i><br>Tie</a>
<a href="purchasecap.php"><i class="icon-list-alt icon-2x"></i><br>Cap</a>
<a href="purchaseid.php"><i class="icon-list-alt icon-2x"></i><br>ID Cards</a>
<a href="purchasebag.php"><i class="icon-list-alt icon-2x"></i><br>Bags</a>-->
<?php
}
?>
