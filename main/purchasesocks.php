...
<!--
		...
		<div class="col-md-12"><center><h2>Purchase Socks</h2></center>
	</div>
...
<hr>
<div class="span10" id="ac" style="margin:10px;">
<table class="maintbl">
	<tr>
	...
	<tr>
		...
		<tr><td class="items"><br> <span >Sizes </span><br><br>
			...
			<td>:</td><td>
				<table class="mini">
					<thead>
						<td >2</td><td>3</td><td>4</td><td>5</td><td>6</td><td>free</td>
					</thead><br>
					<tbody>
						<tr>
							...
							<td><input type="text" style="width: 40px;height: 20px;text-align: center;"/></td>
							<td><input type="text" style="width: 40px;height: 20px;text-align: center;"/></td>
							<td><input type="text" style="width: 40px;height: 20px;text-align: center;"/></td></tr>
						<tr>
							<td><input type="text" style="width: 40px;height: 20px;text-align: center;"/></td>
							<td><input type="text" style="width: 40px;height: 20px;text-align: center;"/></td>
							<td><input type="text" style="width: 40px;height: 20px;text-align: center;"/></td>
