...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li  class="active"><a href="#"><i class="icon-list icon-2x"></i> Stock Details</a>    <ul class="nav nav-list">
	...
	<div class="contentheader">
			<i class="icon-dashboard"></i> Stock Details
			</div>
			<ul class="breadcrumb">
...
<a href="wfabric.php"><i class="icon-list-alt icon-2x"></i><br>Woven Fabrics</a>      
<a href="kfabric.php"><i class="icon-list-alt icon-2x"></i><br> Knit Fabrics</a>     
<a href="trims.php"><i class="icon-list-alt icon-2x"></i><br> Trims</a>  
<a href="accessories.php"><i class="icon-list-alt icon-2x"></i><br> Accessories</a>
<?php
}
?>
