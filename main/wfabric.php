...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a  href="wfabric.php"><i  class="icon-list-alt icon-1x"></i> Woven Fabrics</a></li>      
	...
	<div class="contentheader">
			<i class="icon-dashboard"></i> Woven Fabric
			</div>
			<ul class="breadcrumb">
			<li ><a href="index.php">Dashboard</a></li>/
			<li ><a href="stocks.php">Stock Details</a></li>/
			<li class="active">Woven Fabric</li>
			</ul>
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM fabric_table where type='woven'  ORDER BY f_id  DESC");
				$result->execute();
			...
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM fabric_table where type='woven' and stock < 50 ORDER BY f_id DESC");
				$result->execute();
			...
			<div  >
			Total Number of Fabrics:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
			</div>
			...
			<div style="text-align:center;">
			<div >
			<font style="color:rgb(255, 95, 66);; font:bold 22px 'Aleo';">[<?php echo $rowcount123;?>]</font> Fabrics are below QTY of 50 m 
			</div>
...
<a rel="facebox" href="addwfabric.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Fabric</button></a><br><br>
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="6%"> Rate/m </th>
			<th width="6%"> Stock(m)</th>
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				include('../connect.php');
				$result = $db->prepare("SELECT *, f_rate * stock as total FROM fabric_table where
				 type='woven' ORDER BY supplier_name ");
				$result->execute();
			...
			?>
			</td>			<td><a rel="facebox" title="Click to edit the item" href="editwfabric.php?id=<?php echo $row['f_id']; ?>"><button class="btn btn-warning"><i class="icon-edit"></i> </button> </a>
